                ...
                menu_items: [
                    {
                        ...
                        sub_menu: [{
                            ...
                            },
                            {
                                ...
                                href: "//codecloud.cdn.speedyrails.net/sites/5a8c43eb6e6f641a29020000/application/pdf/1561495347000/Bonnie Doon Directory 06-20-2019_PRINT.pdf",
                                external: true
                            }
                        ]
                    },
        ...
        methods: {
            loadData: async function() {
                try {
                    ...
                    let results = await Promise.all([this.$store.dispatch("LOAD_META_DATA_NEW"), this.$store.dispatch("INITIALIZE_LOCALE"), this.$store.dispatch("getData", "hours"), this.$store.dispatch("getData", "stores")]);
                    return results;
                } catch (e) {
