    		...
    		<div class="row">
    			...
    			<!--<router-link to="/promotions"><i class="fa fa-angle-left"></i> &nbsp; Back to Promotions</router-link>-->
    				...
    				<div class="col-sm-12 no_padding">
        				...
        				<png-map v-bind:png-map-url="getPNGurl" v-bind:initial-position="'500 0'" :height="_.toNumber('600')"></png-map>
    				</div>
		        ...
		        <div class="col-sm-4">
		            <div class="text-center">
    				    ...
    				    <ul class="store_hours_list">
                            ...
                            <span class="col-xs-6">{{hour.day_of_week | moment("dddd", timezone)}}</span>
                            <span class="col-xs-6">{{hour.open_time | moment("h A", timezone)}} - {{hour.close_time | moment("h A", timezone)}}</span>
                            </li>
                        </ul>
