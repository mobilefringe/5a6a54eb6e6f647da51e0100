					...
					<div class="text-center">
						...
						<ul class="store_hours_list">
							<li v-if="storeHours" v-for="hour in storeHours" class="col-xs-12">
								...
								<span v-else class="col-xs-6 text-left"><span v-if="hour.open_time | moment('MM', timezone) == '00'">{{hour.open_time | moment("h A", timezone)}}</span><span></span> - {{hour.close_time | moment("h A", timezone)}}</span>
							</li>
						</ul>
					</div>
				</div>
