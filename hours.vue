            ...
            <div class="all_hours_container">
                ...
                <div class="row">
                    <div class="col-sm-12 ">
                        ...
                        <h3 class="hours_heading text-left" v-if="reducedHolidays">{{$t("hours_page.holiday_hours")}}</h3>
                        ...
                        <h3 class="hours_heading text-left" v-if="closeHolidays">{{$t("hours_page.holiday_closures")}}</h3>
