		...
		<div class="page_header" v-if="storeBanner" v-lazy:background-image="storeBanner.image_url">
			...
			<div class="site_container">
				<div class="header_content">
					<h1><span>{{$t("stores_page.shopping")}}</span></h1>
				</div>
			</div>
		</div>
			...
			<div class="row bold">
				<div class="col-sm-6 col-md-4">
					<div class="store_search" >
						...
						<img src="//codecloud.cdn.speedyrails.net/sites/5a8c43eb6e6f641a29020000/image/png/1517497861636/search_icon_2x.png" class="pull-right" id="store_search_img" alt="">
					</div>
				</div>
				<div class="col-sm-6 col-md-4">
					<div class="store_search" >
