				...
				<div class="row top_bar_wrapper">
					<div class="col-sm-6">
						<div class="mobile_site_logo visible_phone">
						    <router-link to="/"><img src="//codecloud.cdn.speedyrails.net/sites/5af1ff176e6f645120180000/image/png/1519142064997/bonnielogoBlack3x.png" alt="Property Logo"/></router-link>
					    </div>
							...
							<nav id="mobile_nav" v-show="show_mobile_menu">
								<ul>
									<div class="mobile_menu_site_logo">
										<router-link to="/"><img src="//codecloud.cdn.speedyrails.net/sites/5af1ff176e6f645120180000/image/png/1518204428289/bonnielogoWhite3x.png" alt="Property Logo"/></router-link>
									</div>
